...
// chuẩn bị dữ liệu theo vai trò
$appointments = [];
$users = [];

if ($role_id == 2) {
    // lễ tân: xem lịch đang chờ duyệt, chưa ai nhận
    $stmt = $pdo->query("SELECT * FROM appointments WHERE status = 'pending_reception' AND handled_by_receptionist IS NULL ORDER BY created_at DESC");
    $appointments = $stmt->fetchAll();
} elseif ($role_id == 3) {
    // bác sĩ: xem lịch gửi tới mình
    $stmt = $pdo->prepare("SELECT * FROM appointments WHERE assigned_doctor_id = ? AND status = 'sent_to_doctor' ORDER BY appointment_date ASC");
    $stmt->execute([$user_id]);
    $appointments = $stmt->fetchAll();
} elseif ($role_id == 1) {
    // admin tổng: xem danh sách nhân sự
    $stmt = $pdo->query("SELECT id, username, email, role_id FROM users WHERE role_id IN (2,3) ORDER BY created_at DESC");
    $users = $stmt->fetchAll();
}
?>
<!DOCTYPE html><!--
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items compact">
            <li class="nav-item"><a class="nav-link" href="base/accordion.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Accordion</a></li>
            <li class="nav-item"><a class="nav-link" href="base/breadcrumb.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Breadcrumb</a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="base/cards.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Cards</a></li>
            <li class="nav-item"><a class="nav-link" href="base/carousel.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Carousel</a></li>
            <li class="nav-item"><a class="nav-link" href="base/collapse.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Collapse</a></li>
            <li class="nav-item"><a class="nav-link" href="base/list-group.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> List group</a></li>
            <li class="nav-item"><a class="nav-link" href="base/navs-tabs.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Navs &amp; Tabs</a></li>
            <li class="nav-item"><a class="nav-link" href="base/pagination.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Pagination</a></li>
            <li class="nav-item"><a class="nav-link" href="base/placeholders.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Placeholders</a></li>
            <li class="nav-item"><a class="nav-link" href="base/popovers.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Popovers</a></li>
            <li class="nav-item"><a class="nav-link" href="base/progress.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Progress</a></li>
            <li class="nav-item"><a class="nav-link" href="base/spinners.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Spinners</a></li>
            <li class="nav-item"><a class="nav-link" href="base/tables.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Tables</a></li>
            <li class="nav-item"><a class="nav-link" href="base/tooltips.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Tooltips</a></li>
          </ul>
        </li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
          ...
          <ul class="nav-group-items compact">
            <li class="nav-item"><a class="nav-link" href="buttons/buttons.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Buttons</a></li>
            <li class="nav-item"><a class="nav-link" href="buttons/button-group.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Buttons Group</a></li>
            <li class="nav-item"><a class="nav-link" href="buttons/dropdowns.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Dropdowns</a></li>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items compact">
            ...
            <li class="nav-item"><a class="nav-link" href="forms/checks-radios.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Checks and radios</a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="forms/floating-labels.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Floating labels</a></li>
            <li class="nav-item"><a class="nav-link" href="forms/form-control.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Form Control</a></li>
            <li class="nav-item"><a class="nav-link" href="forms/input-group.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Input group</a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="forms/range.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Range</a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="forms/select.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Select</a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="forms/layout.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Layout</a></li>
            <li class="nav-item"><a class="nav-link" href="forms/validation.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Validation</a></li>
          </ul>
        </li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
          ...
          <ul class="nav-group-items compact">
            <li class="nav-item"><a class="nav-link" href="icons/coreui-icons-free.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> CoreUI Icons<span class="badge badge-sm bg-success ms-auto">Free</span></a></li>
            <li class="nav-item"><a class="nav-link" href="icons/coreui-icons-brand.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> CoreUI Icons - Brand</a></li>
            <li class="nav-item"><a class="nav-link" href="icons/coreui-icons-flag.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> CoreUI Icons - Flag</a></li>
          </ul>
        </li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
          ...
          <ul class="nav-group-items compact">
            <li class="nav-item"><a class="nav-link" href="notifications/alerts.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Alerts</a></li>
            <li class="nav-item"><a class="nav-link" href="notifications/badge.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Badge</a></li>
            <li class="nav-item"><a class="nav-link" href="notifications/modals.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Modals</a></li>
            <li class="nav-item"><a class="nav-link" href="notifications/toasts.php"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Toasts</a></li>
          </ul>
        </li>
      ...
      <div class="body flex-grow-1">
        <div class="container-lg px-4">
          <div class="card mb-4">
            ...
            <div class="card-body">
              <?php if ($role_id == 2): ?>
                <h4 class="mb-3">Lịch khám đang chờ lễ tân duyệt</h4>
                    ...
                    <tbody>
                      <?php foreach ($appointments as $app): ?>
                        <tr>
                          ...
                          <td>
                            <a href="reception_handle.php?id=<?php echo $app['id']; ?>" class="btn btn-sm btn-primary">Xử lý</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
              ...
              <?php elseif ($role_id == 3): ?>
                <h4 class="mb-3">Lịch khám gửi tới bạn</h4>
                <?php if (empty($appointments)): ?>
                  <p>Chưa có lịch nào.</p>
                <?php else: ?>
                  <table class="table table-bordered align-middle">
                    ...
                    <tbody>
                      <?php foreach ($appointments as $app): ?>
                        <tr>
                          ...
                          <td><?php echo htmlspecialchars($app['symptoms']); ?></td>
                          <td>
                            <a href="doctor_action.php?id=<?php echo $app['id']; ?>&action=accept" class="btn btn-sm btn-success">Nhận</a>
                            <a href="doctor_action.php?id=<?php echo $app['id']; ?>&action=reject" class="btn btn-sm btn-danger">Từ chối</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
              ...
              <?php elseif ($role_id == 1): ?>
                <h4 class="mb-3">Quản lý lễ tân & bác sĩ</h4>
                <?php if (empty($users)): ?>
                  <p>Chưa có nhân sự.</p>
                <?php else: ?>
                  <table class="table table-bordered align-middle">
                    ...
                    <tbody>
                      <?php foreach ($users as $u): ?>
                        <tr>
                          ...
                          <td><?php echo $u['role_id'] == 2 ? 'Lễ tân' : 'Bác sĩ'; ?></td>
                          <td><a href="admin_delete_user.php?id=<?php echo $u['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Xóa tài khoản này?');">Xóa</a></td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
                  </table>

...
## 📖 1. Giới thiệu
Hệ thống Quản lý Tuyển sinh hệ Đại học được xây dựng nhằm hỗ trợ các trường đại học trong việc tổ chức, theo dõi và xử lý quy trình tuyển sinh. Thay vì quản lý thủ công bằng giấy tờ hoặc bảng tính rời rạc, hệ thống cung cấp một nền tảng tập trung, hiện đại và dễ sử dụng để quản lý hồ sơ thí sinh, xét tuyển, thông báo kết quả và thống kê dữ liệu.
...
Truy cập project qua đường dẫn: 👉 http://localhost/authentication_login

4.3. Setup database
Mở XAMPP Control Panel, Start Apache và MySQL

Truy cập MySQL WorkBench và tạo database:
CREATE DATABASE IF NOT EXISTS quan_ly_doan_vien
   CHARACTER SET utf8mb4
   COLLATE utf8mb4_unicode_ci;

4.4. Setup tham số kết nối
Mở file config.php và chỉnh thông tin kết nối:
<?php
...
Hệ thống có thể cấp tài khoản admin. Sau khi đăng nhập, admin có thể:

Tạo thông tin kỳ tuyển sinh

Thêm hồ sơ thí sinh và cấp tài khoản

Quản lý phân quyền theo vai trò

Xét tuyển và thông báo kết quả


---

Nếu bạn cần thêm phần mô tả chức năng chi tiết, sơ đồ ERD, hoặc hướng dẫn triển khai trên hosting, mình có thể hỗ trợ tiếp nhé!
